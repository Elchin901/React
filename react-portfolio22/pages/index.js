...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark": ""}> 
      <Head>
        <title>Elchin Gonagov Portfolio222</title>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className=" min-h-screen">
          ...
          <h1 className="text-xl  font-burtons">elchingonagov</h1>
            <ul className='flex items-center'>
              ...
              <li>
                <a className="bg-pink-400 text-white px-4 py-2 rounded-md ml-8" href="#">Resume</a>
              </li>
            </ul>
          </nav>
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-pink-400 font-medium md:text-6xl '>Elchin Gonagov</h2>
            <h3 className='text-2xl py-2 md:text-3xl'>Front-end Developer</h3>
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto'>I’m a mysterious individual who has yet to fill out my bio. One thing’s for certain: I love writing front-end code!</p>
          </div>
          <div className='flex justify-center text-5xl py-3 gap-12'>
            <AiFillTwitterCircle/>
            <AiFillLinkedin/>
            <AiFillGithub/>
          </div>
